...
<main class="pt-20">
  <div class="container mx-auto">
    <h1 class="font-viga uppercase text-2xl md:text-3xl text-center dark:text-white">Toyota</h1>
    ...
    <div
      ...
      <div class="overflow-hidden shadow-lg rounded-lg h-90 w-72 md:w-80 cursor-pointer m-auto">
        <a href="#" class="w-full block h-full">
          <img alt="Logo Toyota" src="<?= base_url('asset/img/mobil/toyota/defaulttoyota.jpg'); ?>"
    ...
    <div
      ...
      <div class="overflow-hidden shadow-xl rounded-lg h-80 w-72 md:w-80 cursor-pointer m-auto dark:bg-gray-800">
        <a href="<?= (!empty($item)) ? base_url('toyota') . '/' . $item['slug'] : '#' ; ?>" class="w-full block h-full">
          <img alt="<?= (!empty($item)) ? $item['mobil'] : '' ; ?>"
            src="<?= (!empty($item)) ? base_url('asset/img/mobil/toyota') . '/' . $item['gambar'] : base_url('asset/img/mobil/toyota/defaultToyota.jpg') ; ?>"
            class="max-h-40 w-full object-cover" />
          <div class="bg-white dark:bg-gray-800 w-full p-4">
            <p class="text-indigo-500 text-md font-medium">
              Toyota
    ...
    <!-- PAGINATION -->
    <?= $pager->links('toyota', 'custom_pagination') ?>
  </div>
</main>
