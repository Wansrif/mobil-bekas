...
<main class="pt-20">
  <div class="container mx-auto">
    <h1 class="font-viga uppercase text-2xl md:text-3xl text-center dark:text-white">Honda</h1>
    ...
    <div
      ...
      <div class="overflow-hidden shadow-lg rounded-lg h-90 w-72 md:w-80 cursor-pointer m-auto">
        <a href="#" class="w-full block h-full">
          <img alt="Logo Honda" src="<?= base_url('asset/img/mobil/honda/defaulthonda.jpg'); ?>"
    ...
    <div
      ...
      foreach ($honda as $item) : ?>
      <div class="overflow-hidden shadow-lg rounded-lg h-90 w-72 md:w-80 cursor-pointer m-auto">
        <a href="<?= base_url('honda'); ?>/<?= $item['slug']; ?>" class="w-full block h-full">
          <img alt="<?= $item['mobil']; ?>" src="<?= base_url('asset/img/mobil/honda'); ?>/<?= $item['gambar']; ?>"
            class="max-h-40 w-full object-cover" />
          <div class="bg-white dark:bg-gray-800 w-full p-4">
            <p class="text-indigo-500 text-md font-medium">
              Honda
    ...
    <!-- PAGINATION -->
    <?= $pager->links('honda', 'custom_pagination') ?>
  </div>
</main>
