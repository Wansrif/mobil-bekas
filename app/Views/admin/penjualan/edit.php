...
<main class="mt-20 dark:bg-gray-800 h-full">
  <div class="p-5 space-y-5">
    ...
    <form action="<?= base_url('admin/penjualan/update'); ?>/<?= $penjualan['id_penjualan']; ?>" method="post"
      enctype="multipart/form-data">
      <?= csrf_field(); ?>
      <input type="hidden" name="slug" value="<?= $penjualan['slug']; ?>">
      <input type="hidden" name="gambarLama" value="<?= $penjualan['gambar']; ?>">
      <div class="relative space-y-2">
        ...
        <div class="grid space-y-2 md:space-y-0 md:space-x-2 grid-cols-1 md:grid-cols-2 w-full">
          ...
          <div>
            ...
            <input type="text" id="pembeli"
              ...
              name="pembeli" value="<?= (old('pembeli')) ? old('pembeli') : $penjualan['pembeli'] ?>" />
          ...
          <div>
            ...
            <input type="text" id="mobil"
              ...
              name="mobil" value="<?= (old('mobil')) ? old('mobil') : $penjualan['mobil'] ?>" />
            <div class="text-rose-500 text-xs pl-2">
        ...
        <div>
          ...
          <textarea name="spesifikasi" id="editor"
            ...
            <?= (old('spesifikasi')) ? old('spesifikasi') : $penjualan['spesifikasi'] ?>
          </textarea>
          <div class="text-rose-500 text-xs pl-2">
        ...
        <div>
          ...
          <div class="flex-col">
            <div class="bg-gray-200 max-w-md h-40 rounded-lg flex items-center justify-center mb-2">
              <img src="<?= base_url('asset/img/penjualan'); ?>/<?= $penjualan['gambar']; ?>" id="preview"
        ...
        <div class="grid space-y-2 md:space-y-0 md:space-x-2 grid-cols-1 md:grid-cols-2 w-full">
          ...
          <div class="flex flex-col">
            ...
            <select name="kategori"
              ...
              <option value="<?= (old('nama_kategori')) ? old('nama_kategori') : $penjualan['nama_kategori'] ?>">
                <?= (old('nama_kategori')) ? old('nama_kategori') : $penjualan['nama_kategori'] ?></option>
              <option value="">--- Pilih Kategori ---</option>
              <?php foreach($kategori as $val) : ?>
              <option value="<?= (old('nama_kategori')) ? old('nama_kategori') : $val['nama_kategori'] ?>">
                <?= (old('nama_kategori')) ? old('nama_kategori') : $val['nama_kategori'] ?></option>
              <?php endforeach ?>
            </select>
            <div class="text-rose-500 text-xs pl-2">
          ...
          <div>
            ...
            <input type="text" id="whatsapp"
              ...
              name="whatsapp" value="<?= (old('whatsapp')) ? old('whatsapp') : $penjualan['whatsapp'] ?>"
        ...
        <div class="grid space-y-2 md:space-y-0 md:space-x-2 grid-cols-1 md:grid-cols-2 w-full">
          ...
          <div>
            ...
            <input type="date" id="waktu"
              ...
              name="waktu" value="<?= (old('waktu')) ? old('waktu') : $penjualan['waktu'] ?>" />
            <div class="text-rose-500 text-xs pl-2">
          ...
          <div>
            ...
            <input type="text" id="harga"
              ...
              name="harga" value="<?= (old('harga')) ? old('harga') : $penjualan['harga'] ?>"
