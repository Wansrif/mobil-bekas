...
<main class="mt-20 dark:bg-gray-800 h-full">
  <div class="p-5 space-y-5">
    ...
    <form action="<?= base_url('admin/toyotaadmin/update'); ?>/<?= $toyota['id_toyota']; ?>" method="post"
      enctype="multipart/form-data">
      <?= csrf_field(); ?>
      <input type="hidden" name="slug" value="<?= $toyota['slug']; ?>">
      <input type="hidden" name="gambarLama" value="<?= $toyota['gambar']; ?>">
      <input type="hidden" name="slideLama" value="<?= $toyota['slide']; ?>">
      <input type="hidden" name="slideLama2" value="<?= $toyota['slide2']; ?>">
      <input type="hidden" name="slideLama3" value="<?= $toyota['slide3']; ?>">
      <input type="hidden" name="slideLama4" value="<?= $toyota['slide4']; ?>">
      <div class="relative space-y-2">
        <div>
          ...
          <input type="text" id="mobil"
            ...
            name="mobil" value="<?= (old('mobil')) ? old('mobil') : $toyota['mobil'] ?>" />
        ...
        <div>
          ...
          <div class="flex-col">
            <div class="bg-gray-200 max-w-md h-40 rounded-lg flex items-center justify-center mb-2">
              <img src="<?= base_url('asset/img/mobil/toyota'); ?>/<?= $toyota['gambar']; ?>" id="preview"
        ...
        <!-- SLIDE 1 -->
        <div>
          <label for="slide_toyota" class="text-gray-700">
            Slide 1
            <span class="text-red-500">
          ...
          <div class="flex-col">
            <div class="bg-gray-200 max-w-md h-40 rounded-lg flex items-center justify-center mb-2">
              <img src="<?= base_url('asset/img/mobil/toyota'); ?>/<?= $toyota['slide']; ?>" id="preview1"
                class="h-40 rounded-lg">
            </div>
        ...
        <div>
          ...
          <div class="flex-col">
            <div class="bg-gray-200 max-w-md h-40 rounded-lg flex items-center justify-center mb-2">
              <img src="<?= base_url('asset/img/mobil/toyota'); ?>/<?= $toyota['slide2']; ?>" id="preview2"
                class="h-40 rounded-lg">
            </div>
        ...
        <div>
          ...
          <div class="flex-col">
            <div class="bg-gray-200 max-w-md h-40 rounded-lg flex items-center justify-center mb-2">
              <img src="<?= base_url('asset/img/mobil/toyota'); ?>/<?= $toyota['slide3']; ?>" id="preview3"
                class="h-40 rounded-lg">
            </div>
        ...
        <div>
          ...
          <div class="flex-col">
            <div class="bg-gray-200 max-w-md h-40 rounded-lg flex items-center justify-center mb-2">
              <img src="<?= base_url('asset/img/mobil/toyota'); ?>/<?= $toyota['slide4']; ?>" id="preview4"
                class="h-40 rounded-lg">
            </div>
        ...
        <div>
          <label class="text-gray-700">
            ...
            <textarea name="deskripsi" id="editor"
              class="border border-neutral-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 rounded-lg text-base focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"><?= (old('deskripsi')) ? old('deskripsi') : $toyota['deskripsi'] ?></textarea>
          </label>
          <div class="text-rose-500 text-xs pl-2">
