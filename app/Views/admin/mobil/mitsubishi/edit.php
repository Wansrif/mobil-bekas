...
<main class="mt-20 dark:bg-gray-800 h-full">
  <div class="p-5 space-y-5">
    ...
    <form action="<?= base_url('admin/mitsubishiadmin/update'); ?>/<?= $mitsubishi['id_mitsubishi']; ?>" method="post"
      enctype="multipart/form-data">
      <?= csrf_field(); ?>
      <input type="hidden" name="slug" value="<?= $mitsubishi['slug']; ?>">
      <input type="hidden" name="gambarLama" value="<?= $mitsubishi['gambar']; ?>">
      <input type="hidden" name="slideLama" value="<?= $mitsubishi['slide']; ?>">
      <input type="hidden" name="slideLama2" value="<?= $mitsubishi['slide2']; ?>">
      <input type="hidden" name="slideLama3" value="<?= $mitsubishi['slide3']; ?>">
      <input type="hidden" name="slideLama4" value="<?= $mitsubishi['slide4']; ?>">
      <div class="relative space-y-2">
        <div>
          ...
          <input type="text" id="nama"
            ...
            name="mobil" value="<?= (old('mobil')) ? old('mobil') : $mitsubishi['mobil'] ?>" />
        ...
        <div>
          ...
          <div class="flex-col">
            <div class="bg-gray-200 max-w-md h-40 rounded-lg flex items-center justify-center mb-2">
              <img src="<?= base_url('asset/img/mobil/mitsubishi'); ?>/<?= $mitsubishi['gambar']; ?>" id="preview"
        ...
        <div>
          ...
          <div class="flex-col">
            <div class="bg-gray-200 max-w-md h-40 rounded-lg flex items-center justify-center mb-2">
              <img src="<?= base_url('asset/img/mobil/mitsubishi'); ?>/<?= $mitsubishi['slide']; ?>" id="preview1"
                class="h-40 rounded-lg">
            </div>
        ...
        <div>
          ...
          <div class="flex-col">
            <div class="bg-gray-200 max-w-md h-40 rounded-lg flex items-center justify-center mb-2">
              <img src="<?= base_url('asset/img/mobil/mitsubishi'); ?>/<?= $mitsubishi['slide2']; ?>" id="preview2"
                class="h-40 rounded-lg">
            </div>
        ...
        <div>
          ...
          <div class="flex-col">
            <div class="bg-gray-200 max-w-md h-40 rounded-lg flex items-center justify-center mb-2">
              <img src="<?= base_url('asset/img/mobil/mitsubishi'); ?>/<?= $mitsubishi['slide3']; ?>" id="preview3"
                class="h-40 rounded-lg">
            </div>
        ...
        <div>
          ...
          <div class="flex-col">
            <div class="bg-gray-200 max-w-md h-40 rounded-lg flex items-center justify-center mb-2">
              <img src="<?= base_url('asset/img/mobil/mitsubishi'); ?>/<?= $mitsubishi['slide4']; ?>" id="preview4"
                class="h-40 rounded-lg">
            </div>
        ...
        <div>
          <label class="text-gray-700">
            ...
            <textarea name="deskripsi" id="editor"
              class="border border-neutral-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 rounded-lg text-base focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"><?= (old('deskripsi')) ? old('deskripsi') : $mitsubishi['deskripsi'] ?></textarea>
          </label>
          <div class="text-rose-500 text-xs pl-2">
