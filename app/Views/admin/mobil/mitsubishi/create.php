...
<main class="mt-20 dark:bg-gray-800 h-full">
  <div class="p-5 space-y-5">
    ...
    <form action="<?= base_url('admin/mitsubishiadmin/save'); ?>" method="post" enctype="multipart/form-data">
      <?= csrf_field(); ?>
      <div class="relative space-y-2">
        ...
        <div>
          ...
          <div class="flex-col">
            <div class="bg-gray-200 max-w-md h-40 rounded-lg flex items-center justify-center mb-2">
              <img src="<?= base_url('asset/img/mobil/mitsubishi/defaultMitsubishi.jpg'); ?>" id="preview"
        ...
        <div>
          ...
          <div class="flex-col">
            <div class="bg-gray-200 max-w-md h-40 rounded-lg flex items-center justify-center mb-2">
              <img src="<?= base_url('asset/img/mobil/mitsubishi/defaultMitsubishi.jpg'); ?>" id="preview1"
                class="h-40 rounded-lg">
            </div>
        ...
        <div>
          ...
          <div class="flex-col">
            <div class="bg-gray-200 max-w-md h-40 rounded-lg flex items-center justify-center mb-2">
              <img src="<?= base_url('asset/img/mobil/mitsubishi/defaultMitsubishi.jpg'); ?>" id="preview2"
                class="h-40 rounded-lg">
            </div>
        ...
        <div>
          ...
          <div class="flex-col">
            <div class="bg-gray-200 max-w-md h-40 rounded-lg flex items-center justify-center mb-2">
              <img src="<?= base_url('asset/img/mobil/mitsubishi/defaultMitsubishi.jpg'); ?>" id="preview3"
                class="h-40 rounded-lg">
            </div>
        ...
        <div>
          ...
          <div class="flex-col">
            <div class="bg-gray-200 max-w-md h-40 rounded-lg flex items-center justify-center mb-2">
              <img src="<?= base_url('asset/img/mobil/mitsubishi/defaultMitsubishi.jpg'); ?>" id="preview4"
                class="h-40 rounded-lg">
            </div>
        ...
        <div>
          <label class="text-gray-700">
            ...
            <textarea name="deskripsi" id="editor"
              class="border border-neutral-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 rounded-lg text-base focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"><?= old('deskripsi'); ?></textarea>
          </label>
          <div class="text-rose-500 text-xs pl-2">
