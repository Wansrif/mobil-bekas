...
<main class="mt-20 dark:bg-gray-800 h-screen">
  <div class="p-5 space-y-5">
    ...
    <!-- TAMBAH DATA -->
    <div class="w-full">
      <a href="<?= base_url('admin/mitsubishiadmin/create'); ?>"
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="flex justify-center">
            <img src="<?= base_url('asset/img/mobil/mitsubishi'); ?>/<?= $item['gambar']; ?>" alt="Mobil"
              class="h-36 w-36 rounded-lg">
          </td>
          <td><?= $item['mobil']; ?></td>
          <td>
            <div class="flex justify-center items-center space-x-3">
              <a href="<?= base_url('admin/mitsubishiadmin'); ?>/<?= $item['slug']; ?>"
