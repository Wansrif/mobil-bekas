...
<main class="mt-20 dark:bg-gray-800 h-full">
  <div class="p-5 space-y-5">
    ...
    <form action="<?= base_url('admin/hondaadmin/save'); ?>" method="post" enctype="multipart/form-data">
      <?= csrf_field(); ?>
      <div class="relative space-y-2">
        ...
        <div>
          ...
          <div class="flex-col">
            <div class="bg-gray-200 max-w-md h-40 rounded-lg flex items-center justify-center mb-2">
              <img src="<?= base_url('asset/img/mobil/honda/defaulthonda.jpg'); ?>" id="preview"
        ...
        <div>
          ...
          <div class="flex-col">
            <div class="bg-gray-200 max-w-md h-40 rounded-lg flex items-center justify-center mb-2">
              <img src="<?= base_url('asset/img/mobil/honda/defaulthonda.jpg'); ?>" id="preview1"
                class="h-40 rounded-lg">
            </div>
        ...
        <div>
          ...
          <div class="flex-col">
            <div class="bg-gray-200 max-w-md h-40 rounded-lg flex items-center justify-center mb-2">
              <img src="<?= base_url('asset/img/mobil/honda/defaulthonda.jpg'); ?>" id="preview2"
                class="h-40 rounded-lg">
            </div>
        ...
        <div>
          ...
          <div class="flex-col">
            <div class="bg-gray-200 max-w-md h-40 rounded-lg flex items-center justify-center mb-2">
              <img src="<?= base_url('asset/img/mobil/honda/defaulthonda.jpg'); ?>" id="preview3"
                class="h-40 rounded-lg">
            </div>
        ...
        <div>
          ...
          <div class="flex-col">
            <div class="bg-gray-200 max-w-md h-40 rounded-lg flex items-center justify-center mb-2">
              <img src="<?= base_url('asset/img/mobil/honda/defaulthonda.jpg'); ?>" id="preview4"
                class="h-40 rounded-lg">
            </div>
