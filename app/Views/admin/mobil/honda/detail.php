...
<main class="mt-20 dark:bg-gray-800 h-screen">
  <div class="p-5 space-y-5">
    ...
    <section class="flex space-x-4">
      <!-- EDIT -->
      <a href="<?= site_url('admin/hondaadmin/edit'); ?>/<?= $honda['slug']; ?>">
        <button
            ...
            <div class="w-full h-full text-center">
              <div class="flex h-full flex-col justify-between">
                ...
                <div class="grid grid-cols-2 items-center justify-between gap-4 w-full mt-8">
                  ...
                  <form action="<?= base_url('admin/hondaadmin'); ?>/<?= $honda['id_honda']; ?>" method="post">
                    <?= csrf_field(); ?>
    ...
    <section class="bg-gray-100 dark:bg-gray-900 lg:py-12 lg:flex lg:justify-center">
      <div class="bg-white dark:bg-gray-800 lg:mx-10 lg:flex lg:w-full lg:shadow-lg lg:rounded-lg">
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <img class="h-64 bg-cover w-full lg:rounded-lg lg:h-full"
                src="<?= base_url('asset/img/mobil/honda'); ?>/<?= $honda['gambar']; ?>" alt="slide gambar">
            </div>
            <div class="swiper-slide">
              <img class="h-64 bg-cover w-full lg:rounded-lg lg:h-full"
                src="<?= base_url('asset/img/mobil/honda'); ?>/<?= $honda['slide']; ?>" alt="slide gambar">
            </div>
            <div class="swiper-slide">
              <img class="h-64 bg-cover w-full lg:rounded-lg lg:h-full"
                src="<?= base_url('asset/img/mobil/honda'); ?>/<?= $honda['slide2']; ?>" alt="slide gambar">
            </div>
            <div class="swiper-slide">
              <img class="h-64 bg-cover w-full lg:rounded-lg lg:h-full"
                src="<?= base_url('asset/img/mobil/honda'); ?>/<?= $honda['slide3']; ?>" alt="slide gambar">
            </div>
            <div class="swiper-slide">
              <img class="h-64 bg-cover w-full lg:rounded-lg lg:h-full"
                src="<?= base_url('asset/img/mobil/honda'); ?>/<?= $honda['slide4']; ?>" alt="slide gambar">
            </div>
          </div>
        ...
        <div class="max-w-xl px-6 py-12 lg:max-w-5xl lg:w-1/2">
          <h2 class="text-2xl font-bold text-gray-800 dark:text-white md:text-3xl"><?= $honda['mobil']; ?></h2>
          <p class="mt-4 text-gray-600 dark:text-gray-400"><?= $honda['deskripsi']; ?></p>

          <div class="mt-8">
            <a href="#"
              class="px-5 py-2 font-medium text-gray-100 transition-colors duration-200 transform bg-green-600 rounded-md hover:bg-green-500">Contact
              Now</a>
          </div>
        </div>
      </div>
